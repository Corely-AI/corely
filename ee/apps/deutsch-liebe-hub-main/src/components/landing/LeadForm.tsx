      ...
      <section id="lead-form" className="py-16 md:py-24">
        <div className="container mx-auto px-4 max-w-lg text-center space-y-6">
          ...
          <p className="text-muted-foreground leading-relaxed">
            Trang sẽ liên hệ trong thời gian sớm nhất để test trình độ và tư vấn combo phù hợp. Trong lúc chờ, bạn có thể inbox trực tiếp để giữ chỗ.
          </p>
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Button variant="hero" size="lg" asChild>
              <a href="https://m.me/ThuTrangNguyenGermany" target="_blank" rel="noopener noreferrer">
      ...
      <div className="container mx-auto px-4 max-w-lg">
        <div className="bg-card rounded-2xl p-6 md:p-8 card-shadow border border-border">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <Label htmlFor="city" className="text-foreground">Bạn đang ở thành phố nào tại Đức?</Label>
              <Input id="city" name="city" required placeholder="Berlin, München…" className="mt-1" />
            </div>
            ...
            <div>
              <Label htmlFor="contact" className="text-foreground">Số điện thoại (WhatsApp) hoặc Email</Label>
              <Input id="contact" name="contact" required placeholder="+49… hoặc email@..." className="mt-1" />
            </div>
            ...
            <div className="flex items-start gap-2">
              ...
              <label htmlFor="consent" className="text-xs text-muted-foreground leading-relaxed cursor-pointer">
                Tôi đồng ý với <a href="#" className="text-primary underline">Chính sách bảo mật (Datenschutzerklärung)</a> và cho phép liên hệ tư vấn.
              </label>
            </div>

            <Button variant="hero" size="xl" className="w-full" type="submit" disabled={!consent}>
              <ArrowDown className="w-4 h-4 mr-2" /> Nhận tư vấn miễn phí
            </Button>
          </form>
        </div>
      </div>
