...
| `workflow.ai_task.freeform`          | `packages/prompts/src/prompts/workflows.ts`  | Generic workflow AI task wrapper                   | API background workflow handler   | Internal automation            |
...
- `services/api/src/modules/background/runtime/modules/workflows/handlers/ai-task.handler.ts` (workflow AI task handler)
