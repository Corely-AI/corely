...
export const buildPurchasingTools = (_app: PurchasingApplication): DomainToolPort[] => [
  {
  ...
  },
  {
    ...
    execute: async ({ input }) => {
      ...
      return ExpenseChangesNarrativeCardSchema.parse({
        ok: true,
        narrative: "Spend changes are driven by updated vendor bills and recurring subscriptions.",
        highlights: [],
        confidence: 0.4,
