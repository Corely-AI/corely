...
export const DailyClosingStep = ({
  ...
  const cta = config.ctaLabel?.[locale] || config.ctaLabel?.["en"] || "Got it";

  return (
    <div className="mx-auto flex max-w-lg flex-col p-6 lg:p-12 text-center">
      ...
      <div className="relative mb-8 aspect-video w-full overflow-hidden rounded-xl border bg-muted group cursor-pointer">
        ...
        {/* In real app, put a thumbnail or video player here */}
        <img
