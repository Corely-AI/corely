...
import { Button, Card, CardHeader, CardContent, CardTitle, CardDescription, Badge, Separator } from "@corely/ui";
import { crmApi } from "@/lib/crm-api";
import { toast } from "sonner";
import { SequenceEnrollmentCard } from "@/modules/crm/components/SequenceEnrollmentCard";
...
export default function LeadDetailPage() {
  ...
  const convertMutation = useMutation({
    mutationFn: () => crmApi.convertLead({ leadId: id!, dealTitle: lead?.companyName ? `${lead.companyName} Deal` : undefined }),
    onSuccess: (data) => {
  ...
  const handleConvert = () => {
    if (confirm("Are you sure you want to convert this lead? This will create a Contact, Company (if applicable), and Deal.")) {
