...
type CoursePackagesProps = CommonBlockProps & RuntimeProps & { heading?: string };
        ...
        <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
          {combos.map((combo, i) => (
            <div
              key={i}
              className={cn(
                "relative bg-card rounded-2xl p-6 card-shadow border transition-all duration-300 hover:card-shadow-hover flex flex-col",
            ...
            >
              ...
              <Button
                ...
                asChild
              >
                <Link href={resolveInternalHref("/contact", props.basePath)}>Chọn combo này</Link>
              </Button>
            </div>
          ))}
        </div>
