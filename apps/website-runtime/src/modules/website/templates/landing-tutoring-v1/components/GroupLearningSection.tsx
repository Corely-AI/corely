...
type GroupLearningSectionProps = CommonBlockProps & RuntimeProps & { heading?: string };

export const GroupLearningSection = (props: GroupLearningSectionProps) => {
  return (
    <section
      id={props.anchorId ?? "dung-hoc-1-1"}
      className={sectionClass(
        props,
        "py-16 md:py-24 bg-gradient-to-b from-background to-accent/20"
      )}
    >
