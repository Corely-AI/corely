        ...
        <div className="grid md:grid-cols-2 gap-10 items-center">
          <div className="space-y-6">
            ...
            <h1 className="text-3xl md:text-5xl font-extrabold leading-tight tracking-tight text-foreground">
              {props.headline ?? (
                <>
                  Học tiếng Đức để <span className="text-gradient-brand">dùng được ngay</span> — tự
                  tin giao tiếp từ <span className="text-primary">phát âm chuẩn</span>.
                </>
              )}
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-3 pt-2">
              <Button variant="hero" size="xl" asChild>
                <Link href={resolveInternalHref(primaryHref, props.basePath)}>
                  {props.primaryCtaLabel ?? "Nhận tư vấn & xếp lớp"}
                </Link>
              </Button>
