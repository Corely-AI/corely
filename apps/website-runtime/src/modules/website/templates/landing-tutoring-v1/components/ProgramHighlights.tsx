import { BookOpen, Clock, MessageCircle, Target, Users, Video } from "lucide-react";
import { type CommonBlockProps, type RuntimeProps, sectionClass } from "./shared";

type ProgramHighlightsProps = CommonBlockProps & RuntimeProps & { heading?: string };
...
export const ProgramHighlights = (props: ProgramHighlightsProps) => {
  return (
    <section
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-2xl md:text-4xl font-bold text-foreground mb-3">
            {props.heading ?? "Điểm khác biệt tại DEUTSCH LIEBE"}
          </h2>
